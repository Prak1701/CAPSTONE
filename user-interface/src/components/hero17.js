            ...
            {props.content1 ?? (
              <Fragment>
                <span className="hero17-text6">
                  Protect yourself from email scams by using our advanced
                  phishing email detection tool. Simply input the email content
                  and subject to scan for any potential threats.
                </span>
              </Fragment>
            )}
          </p>
        ...
        <div className="hero17-actions">
          <button className="thq-button-filled">
            <span className="thq-body-small">
              {props.action1 ?? (
                <Fragment>
                  <span className="hero17-text4">Get Started</span>
                </Fragment>
              )}
            </span>
          </button>
...
Hero17.defaultProps = {
  ...
  image1Alt: 'Phishing Email Detection Tool',
  image7Src:
